...
class _AddBusinessState extends State<AddBusiness> {
  ...
  AddBusinessRepository repository = AddBusinessRepository(Dio());
...
// var image = await ImagePicker.pickImage(source: ImageSource.gallery);
  ...
  void _addbusiness() async {
    if (_formKey.currentState!.validate()) {
      final AddBusinessModel isAdded = (await repository.addBusiness(
          _image,
      ...
      if (isAdded.status == true) {
        ...
        ScaffoldMessenger.of(context)
            .showSnackBar(const SnackBar(content: Text('Business Added')));
      } else {
        // ignore: use_build_context_synchronously
        ScaffoldMessenger.of(context)
